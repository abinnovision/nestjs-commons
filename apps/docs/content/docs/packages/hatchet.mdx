---
title: "@abinnovision/nestjs-hatchet"
description: NestJS integration for Hatchet — distributed workflow orchestration with type-safe decorators and event handling.
---
